...
// var api_host = "lxd0.uvoo.io"
// var api_port = "13000"
// var CITY_QUERY_URL_PREFIX = 'http://lxd:13000/city?name=ilike.'
// var CITY_QUERY_URL_PREFIX = 'http://lxd0.uvoo.io:13000/city?name=ilike.'
//
//var CITY_QUERY_URL_PREFIX = 'http://' + api_host + ':' + api_port + '/city?name=ilike.'
// var CITY_QUERY_URL_PREFIX = `http://${api_host}:${api_port}/city?name=ilike.`
var CITY_QUERY_URL_PREFIX = `http://${api.host}:${api.port}/city?name=ilike.`
